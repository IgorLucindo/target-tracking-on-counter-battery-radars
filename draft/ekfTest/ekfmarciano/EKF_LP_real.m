...
delta_Tracking = 25; %  28.5500//  35.95  //4seg. de tracking\\TOTAL 23.85 Atenção: o tempo total de rastreio é 23,8s //10%= 2.3850   //20%= 4.7700 //25%= 5.9625// 30%=7.1550  // 35%=8.3475 //40%=9.5400 //45%= 10.7325 // 50%= 11.9250
...
xE2A = xE2A(amostra_inicio:end)';
yN2A = yN2A(amostra_inicio:end)';
zU2A = zU2A(amostra_inicio:end)';
tr2A = tr2A(amostra_inicio:end)';
...
f66 = -xk_k(7,k)*((V^2)+vz^2)/(2*V+ee); %-xk_k(7,k)*(vz^2)/(2*V+ee);
f67 = -V*vz/2;
...
% tempoProcessamento = toc; % Encerra a cronometragem e armazena o tempo

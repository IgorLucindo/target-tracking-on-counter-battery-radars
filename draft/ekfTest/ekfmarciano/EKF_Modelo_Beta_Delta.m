...
Delta_Bheta = zeros(1,tam); 
Delta_Bheta(1) = (1.148)*((m/(S*C_d0)));   %8.7328e+03;
Bheta_0 = 8.7328e+03;
%lamb(1) =alpha(1)*p0;
%lamb(1) =  2.7483e-04;
%lamb(1) =0;
...
xk_k(:,1)  = [po; v_(:,1) ; Delta_Bheta(1)];    % Definir estimativa inicial do estado
sig2v= 150^2;       %
%sig2v = var(VelDist)
...
q_Bheta_Delta =(1.2*10)^5;%(2*10^4)^2;
...
Q_k = [q_x        0          0        0; %10^-8
      0           q_y        0        0;
      0           0          q_z      0;
      0           0          0        q_Bheta_Delta ]; %5*10^-8 %(7.25*10^-13)*exp(-0.00005*xk_k(3,k-1))
...
vz = xk_k(6,k);
%alpha(k) = xk_k(7,k);
Delta_Bheta = xk_k(7,k);
%alpha(k-1) = xk_k(7,k-1);
ee =0;
%===== Elementos da Matriz Jacobiana===================================================================================

f43 = (-Pp*h/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*vx;   % xk_k(7,k) = alpha(k)
%f43 = 0;
f44 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(((vx/V)^2)+1); % 
f45 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vx*vy/(V^2)); % 
f46 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vx*vz/(V^2));
f47 = (-Pp*vx/(Bheta_0^2));

f53 = (-Pp*h/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*vy;   % xk_k(7,k) = alpha(k)
%f53 = 0;
f54 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vx*vy/(V^2));
f55 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(((vy/V)^2)+1);
f56 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vy*vz/(V^2));
f57 = (-Pp/(Bheta_0^2))*vy;

f63 = (-Pp*h/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*vz;   % xk_k(7,k) = alpha(k)
%f63 = 0;
f64 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vx*vz/(V^2));
f65 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(vy*vz/(V^2));
f66 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*(((vz/V)^2)+1);
f67 = (-Pp*vz/(Bheta_0^2));
...
x_2 = xk_k(5,k);
x_3 = xk_k(6,k);
x_4 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*x_1;
x_5 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*x_2;
x_6 = (Pp/Bheta_0)*(1-(xk_k(7,k)/Bheta_0))*x_3 - g;
x_7 = 0;
...
esc_min = C_d-0.05;
esc_max = C_d+0.05;
plot(t(1:end),C_d(1:length(t)),'k-','Linewidth',1.5); %axis([t(5) t(end) esc_min esc_max])
...
subplot(2,1,2);
plot(t(1:end),Cd_est(1:end),'r-','Linewidth',1); grid ; hold on;
plot(t(1:end),C_d(1:length(t)),'k-','Linewidth',1); axis([t(1) t(end) 0.09 0.12])
title('Coeficiente de Arrasto','Interpreter','latex','FontSize',13);
xlabel('tempo(s)','Interpreter','latex','FontSize',12)
